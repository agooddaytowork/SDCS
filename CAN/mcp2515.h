...
#ifndef SPI_CAN_MSP432_TIRTOS_V2_SENDING_MCP2515_H_
#define SPI_CAN_MSP432_TIRTOS_V2_SENDING_MCP2515_H_

#include <stdint.h>

/* Error counter declaration */
extern uint8_t can_tx_error_counter;
extern uint8_t can_rx_error_counter;
extern void CAN_CS_LOW();
extern void CAN_CS_HIGH();
/* User configuration */
#define CAN_SPI_CS_PORTBIT BIT3
#define CAN_SPI_CS_PORTOUT P4OUT
#define CAN_SPI_CS_PORTDIR P4DIR
...
/* SDCS configuration Define */
#define CAN_CONFIG_TAIL  0x0f
#define CAN_CONFIG_VALID 0b10000000
#define CAN_HAS_GAUGE	 0b01000000
#define CAN_TWO_PUMPS	 0b00000001
#define CAN_NO_RFID 	 0b00000010

// Module crystal 16Mhz, 22pF capacitors
...
int8_t SDCS_Data_response(void);
void getData(void);


#endif /* SPI_CAN_MSP432_TIRTOS_V2_SENDING_MCP2515_H_ */
